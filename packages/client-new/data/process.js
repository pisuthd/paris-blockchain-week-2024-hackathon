export const processes = [
  {
    ...
    description:
      "Once you've set up your wallet of choice, connect it to OpenSeaby clicking the Ride the Silver Wave in the top right corner.",
  },
  {
    id: 2,
...
export const process2 = [
  {
    ...
    description:
      "Once you've set up your wallet of choice, connect it to OpenSeaby clicking the Ride the Silver Wavein.",
    svgPath:
