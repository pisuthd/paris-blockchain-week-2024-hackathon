      ...
      <div className="container">
        ...
        <div className="article-content mx-auto max-w-[48.125rem]">
          ...
          <p>
            ...
            the SilverSurfer website(s), our APIs, mobile app (the “App”), and any
          ...
          <p>
            SilverSurfer is not a wallet provider, exchange, broker, financial
            institution, or creditor. SilverSurfer provides a peer-to-peer web3
          ...
          <p>
            ...
            SilverSurfer logo and all designs, text, graphics, pictures, data,
            software, sound files, other files, and the selection and
            arrangement thereof are the proprietary property of SilverSurfer or our
          ...
          <p>
            These Terms constitute the entire agreement between you and SilverSurfer
            ...
            assigned by you without the prior written consent of SilverSurfer, and
            SilverSurfer’s failure to assert any right or provision under these
          ...
          <p>
            ...
            applicable local laws. You and SilverSurfer agree that the United
